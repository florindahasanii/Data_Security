...
class Morse:
    ...
    #extract invidual characters from plain text
    #then add to charset or morsechar depending on which type of char

    def parse_morse_file(self):
        for line in self.morse_file_content:
            #split the line based on space between the char and plain
            line = line.split(" ")
            morse_char = line[0]
